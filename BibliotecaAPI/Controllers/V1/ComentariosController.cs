...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [EndpointSummary("Obtiene los comentarios de un libro")]
        ...
        [AllowAnonymous]
        [EndpointSummary("Obtiene un comentario de un libro")]
        [OutputCache(Tags = [cache])]
        public async Task<ActionResult<ComentarioDTO>> GetPorId(Guid id)
        {
        ...
        [EndpointSummary("Crea un comentario de un libro")]
        ...
        [EndpointSummary("Actualiza parcialmente un comentario de un libro")]
        ...
        [EndpointSummary("Actualiza un comentario de un libro")]
        public async Task<ActionResult> Put(int libroId, Guid id, ComentarioCreacionDTO comentarioCreacionDTO)
        {
            var existeLibro = await context.Libros.AnyAsync(x => x.Id == libroId);
        ...
        [EndpointSummary("Borra un comentario de un libro")]
